...
payload = {
    ...
    "items": [
        {
            "anotation": "*FAVOR NO EFECTUAR RETENCION EN LA FUENTE* Regimen simple de tributación.  Forma de pago por transferencia electrónica a la CUENTA DE AHORROS 28070119350 de BANCOLOMBIA, a NOMBRE DE GRUPO MERAKI.  Autorizo en caso de incumplimiento de esta obligación sea reportado a las centrales",
            "id": 5,
            "name": "COMPENSACIÓN",
            "price": monto_cop,
