...
):  # 200 OK or 201 Created are typically success statuses
    print("Invoice created successfully.")
else:
    print(
        f"Failed to create invoice. Status code: {response.status_code}, Message: {response.text}"
    )
